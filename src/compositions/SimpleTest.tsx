...
export const SimpleTest: React.FC = () => {
  ...
  const cameraConfig = useMemo(() => {
    const panX = interpolate(frame, [0, 120], [-0.1, 0.1]);
    return {
      pos: [panX, 0.05, 2.5] as [number, number, number],
      fov: 28,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <directionalLight position={[-3, 2, 2]} intensity={0.8} color="#94a3b8" />

        {/* Diagnostic Avatar with Single-Arm Raise Motion */}
        <SimpleTestAvatar scale={1.0} modelName="models/Rattle_rigging.glb" />
      </ThreeCanvas>
    </AbsoluteFill>
  );
};
