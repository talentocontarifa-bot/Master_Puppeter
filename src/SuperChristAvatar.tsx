...
export const SuperChristAvatar: React.FC<Props> = ({ scale = 1.0, useAIMotion = true }) => {
  ...
  // Retarget FBX tracks onto SuperChrist GLB using Handicap Engine
  useEffect(() => {
